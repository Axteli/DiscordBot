...
module.exports.run = async(bot, message, args) => {
    ...
    if(member.id === '761914312422981632') return message.channel.send('Pourquoi veut tu me ban? tu ne m\'aime pas? :cry:'),console.log(`commande : ban | par : ${message.author.tag} (${message.author.id}) | dans : ${message.channel.name} (${message.channel.id})| serveur : ${message.guild} (${message.guild.id})| détails : a essayé de se ban sois-meme`)
