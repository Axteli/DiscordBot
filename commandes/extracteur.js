...
module.exports.run = async(bot, message, args) => {
    ...
    message.delete();
    console.log(`commande : extracteur | par : ${message.author.tag} (${message.author.id}) | dans : ${message.channel.name} (${message.channel.id})| serveur : ${message.guild} (${message.guild.id})`)
